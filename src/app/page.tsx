              ...
              <RevealItem delay={160}>
                <div>
                  ...
                  <p className="text-base text-neutral-600 dark:text-neutral-400 leading-relaxed">
                    When I made custom <code className="font-mono text-violet-600 dark:text-violet-400">clip-path</code> shapes for <a className="font-mono text-violet-600 dark:text-violet-400" href="https://jeremyauguste.vercel.app">my portfolio site</a>, I thought there should be a tool out there that could help make the process easier. However, the ones I found didn't offer as much help as I wanted. After I made some mistakes creating shapes by hand and realizing that I couldn't scale them down properly, I had to find a better way. This want for an easy-to-use tool and a need to submit an AI-powered project for my Low and No-Code course at UCF led me to make this site.
                  </p>
                </div>
              </RevealItem>
