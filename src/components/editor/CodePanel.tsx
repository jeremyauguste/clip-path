...
export function CodePanel() {
  const { cssOutput, setCssOutput, setPoints, canvasSettings, pushHistory } = useEditorStore();
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-900 border-l border-neutral-800">
      <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-800">
        <span className="text-xs font-mono text-neutral-400 uppercase tracking-wider">CSS Output</span>
        <Button
          size="sm"
          variant="ghost"
      ...
      <textarea
        className="flex-1 resize-none bg-transparent font-mono text-sm text-violet-300 p-4 focus:outline-none placeholder:text-neutral-600"
        value={cssOutput}
